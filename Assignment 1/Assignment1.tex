...
In \fref{fig:fr1}, for an approximate 3dB change in frequency (as shown by both cursors), we see the phase shift by approximately $45^{\circ}$.
...
\end{gather*}
\newpage
Using the corresponding values taken from \fref{tab:values2} into the above equations, we get the matrix for the Z parameters:
$$ Z = \begin{bmatrix}
...
\begin{figure}[ht]
    \centering
    \makebox[\textwidth]{\includegraphics[width=0.8\columnwidth]{resources/maxpowerresistance.png}}
